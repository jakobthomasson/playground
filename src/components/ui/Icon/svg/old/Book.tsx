...
const Book: FunctionComponent<SVGProps<SVGSVGElement>> = props => (
  <svg viewBox="0 0 485.5 485.5">
    <g>
      <g>
        <path
          d="M422.1,126.2H126.4c-27.4,0-49.8-22.3-49.8-49.8c0-27.4,22.3-49.8,49.8-49.8h295.8c7.4,0,13.3-6,13.3-13.3
        ...
        <path
          d="M177.4,400.7c1.5,0.5,3,0.8,4.5,0.8c5.5,0,10.6-3.4,12.5-8.8l16.2-45.3H273c0.5,0,1.1,0,1.6-0.1l16.2,45.4
