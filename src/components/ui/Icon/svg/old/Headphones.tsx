...
const Headphones: FunctionComponent<SVGProps<SVGSVGElement>> = props => (
  <svg viewBox="0 0 467.2 467.2">
    <g>
      <path
        d="M467.2,235.7c0-62.4-24.3-121.1-68.4-165.2S296,2.1,233.6,2.1S112.5,26.4,68.4,70.5S0,173.3,0,235.7v110.6
