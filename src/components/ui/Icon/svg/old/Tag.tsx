...
const Tag: SFC<SVGProps<SVGSVGElement>> = props => (
  <svg viewBox="0 0 487.85 487.85">
    <g>
      <path
        d="M479,215.275l-83.5-113.9c-11-15-33.3-26.3-51.8-26.3H39.2c-21.6,0-39.2,17.6-39.2,39.2v259.3c0,21.6,17.6,39.2,39.2,39.2
